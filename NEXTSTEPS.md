...
# Next Steps for ndx-spikesorting Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-spikesorting directory: `cd ndx-spikesorting`
...
`spec/ndx-spikesorting.namespace.yaml` and
`spec/ndx-spikesorting.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_spikesorting/__init__.py` includes an
...
`src/pynwb/ndx_spikesorting/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_spikesorting/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_spikesorting/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-spikesorting
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/h-mayorquin/ndx-spikesorting/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-spikesorting/0.1.0
...
`staged-extensions/ndx-spikesorting`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-spikesorting
    ```

13. Edit `staged-extensions/ndx-spikesorting/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/h-mayorquin/ndx-spikesorting
      pip: https://pypi.org/project/ndx-spikesorting/
      license: MIT
      maintainers: 
        - h-mayorquin
      ```

14. Edit `staged-extensions/ndx-spikesorting/README.md`
to add information about your extension. You may copy it from
`ndx-spikesorting/README.md`.

  ```bash
  cp ndx-spikesorting/README.md staged-extensions/ndx-spikesorting/README.md
  ```
...
ndx-spikesorting-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-spikesorting GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-spikesorting-record repository on GitHub.
