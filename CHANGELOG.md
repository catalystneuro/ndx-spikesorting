# Changelog for ndx-spikesorting

# v0.1.1 (Upcoming)

### Features
* Added `to_dense` method to the `Templates` class for converting sparse ragged templates to dense 3D arrays. [PR #3](https://github.com/catalystneuro/ndx-spikesorting/pull/3)
